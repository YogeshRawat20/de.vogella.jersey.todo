...
//	  Request request;
	  ...
	  public List<Todo> getTodosBrowser() {
		System.out.println("TodosResource--> getTodosBrowser()");
	  ...
	  public List<Todo> getTodos() {
		System.out.println("TodosResource--> getTodos()");
	    List<Todo> todos = new ArrayList<Todo>();
	    todos.addAll(TodoDao.instance.getModel().values());
	    return todos; 
	  }
	// retuns the number of todos
	  ...
	  public void newTodo(@FormParam("id") String id,
		...
		System.out.println("TodosResource--> newTodo()");
	...
	// Defines that the next path parameter after todos is
	  ...
	  public Todo getTodo(@PathParam("todo") String id) {
		System.out.println("TodosResource--> getTodo()");
//		System.out.println("UriInfo	:	"+uriInfo.getBaseUri());
//		System.out.println("UriInfo	:	"+uriInfo.getPath());
//		System.out.println("UriInfo	:	"+uriInfo.getAbsolutePath());
